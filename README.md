...
Five different optimizers are compared for their results and convergence time (SGD, Adam, Adagrad, Adadelta, RMSprop) along with three different activation functions (ReLu, Tanh, Sigmoid). Figures show the training loss for different optimizers.
...
![](https://github.com/saba6099/Deep-Learning-for-vision/blob/master/Assignment%203/relu.png "Kernel Visualizations")
